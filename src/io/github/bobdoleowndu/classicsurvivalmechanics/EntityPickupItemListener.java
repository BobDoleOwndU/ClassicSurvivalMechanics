...
public class EntityPickupItemListener implements Listener
{
	...
	public void onItemSpawn(ItemSpawnEvent event)
	{
		...
		{
			//If the stack if greater than one, we want to replace it with individual stacks of one.
			//Else, we add a randomly generated long to the food's lore, making it a unique item.
			//Technically these items can still be stacked; but the chance of an item that's stackable spawning with them is
			//one in 2,147,483,647.
